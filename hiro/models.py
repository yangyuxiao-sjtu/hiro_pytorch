...
class TD3Controller(object):
    ...
    def _train(self, states, goals, actions, rewards, n_states, n_goals, not_done,is_high_con=False):
        self.total_it += 1
        with torch.no_grad():
            noise = (
...
class HigherController(TD3Controller):
    ...
    def train(self, replay_buffer, low_con,use_correction=True):
        ...
        return self._train(states, goals, actions, rewards, n_states, goals, not_done,is_high_con=True)
